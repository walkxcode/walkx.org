...
if ("fetch" in window) {
  wcB.insertAdjacentHTML("beforeEnd", wcC),
    wcB.insertAdjacentHTML(
      "beforeEnd",
      '<span id="wcb_2"></span>!&nbsp;<i><span id="wcb_g">Measuring CO<sub>2</sub>&hellip;</span></i>&nbsp;(<a id="wcb_a" target="_blank" rel="noopener" href="https://www.websitecarbon.com/website/walkx-org/">Website Carbon</a>)'
    );
