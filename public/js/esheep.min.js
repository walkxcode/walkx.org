...
var VERSION = "0.9.2",
  ACTIVATE_DEBUG = !1,
  DEFAULT_XML =
    "https://adrianotiger.github.io/desktopPet/Pets/esheep64/animations.xml",
  COLLISION_WITH = ["div", "hr"],
  eSheep = (function () {
    function eSheep(e, t) {
      _classCallCheck(this, eSheep),
        (this.userOptions = e || { allowPets: "none", allowPopup: "yes" }),
        this.userOptions.allowPopup || (this.userOptions.allowPopup = "yes"),
        this.userOptions.allowPets || (this.userOptions.allowPets = "none"),
      ...
      _createClass(eSheep, [
        {
          ...
          value: function (e) {
            ...
            var t = new XMLHttpRequest(),
              i = this;
            t.open("GET", this.animationFile, !0),
              t.addEventListener("readystatechange", function () {
                4 == this.readyState &&
                  (200 == this.status
                    ? i._parseXML(this.responseText)
                    : console.error(
                        "XML not available:" +
                          this.statusText +
                          "\n" +
        ...
        },
        {
          ...
          value: function () {
            ...
            (this.prepareToDie = !0),
              this.DOMinfo.Hide(),
              setTimeout(function () {
                (e.DOMdiv = e.DOMimg = e.DOMinfo = null),
        ...
        },
        {
          ...
          value: function (e) {
            ...
            (this.tilesX = i.getElementsByTagName("tilesx")[0].textContent),
              (this.tilesY = i.getElementsByTagName("tilesy")[0].textContent),
              this.sprite.addEventListener("load", function () {
                ...
                var e =
                  ...
                  "px;height:" +
                  t.sprite.height +
                  "px;position:absolute;top:0px;left:0px;max-width: none;";
                t.DOMimg.setAttribute("style", e),
                  t.DOMimg.addEventListener("dragstart", function (e) {
                    return e.preventDefault(), !1;
                  }),
                  (t.imageW = t.sprite.width / t.tilesX),
                  (t.imageH = t.sprite.height / t.tilesY),
                  (e =
                    "width:" +
                    t.imageW +
                    "px;height:" +
                    ...
                    "px;left:" +
                    t.imageX +
                    "px;transform:rotatey(0deg);cursor:move;z-index:2000;overflow:hidden;image-rendering: crisp-edges;"),
                  t.DOMdiv.setAttribute("style", e),
                  t.DOMdiv.appendChild(t.DOMimg),
                  t.isChild ? t._spawnChild() : t._spawnESheep();
              }),
              (this.sprite.src =
                "data:image/png;base64," +
                i.getElementsByTagName("png")[0].textContent),
              ...
              this.DOMdiv.addEventListener("mousemove", function (e) {
                if (!t.dragging && 1 == e.buttons && 0 == e.button) {
                  ...
                  for (
                    ...
                    if (
                      "drag" == i[n].getElementsByTagName("name")[0].textContent
                    ) {
                      (t.animationId = i[n].getAttribute("id")),
                        (t.animationStep = 0),
                        (t.animationNode = i[n]);
                      break;
                    }
              ...
              document.body.addEventListener("mousemove", function (e) {
                t.dragging &&
                  ((t.imageX = parseInt(e.clientX) - t.imageW / 2),
                  (t.imageY = parseInt(e.clientY) - t.imageH / 2),
                  (t.DOMdiv.style.left = t.imageX + "px"),
                  (t.DOMdiv.style.top = t.imageY + "px"),
                  (t.DOMinfo.style.left =
                    parseInt(t.imageX + t.imageW / 2) + "px"),
                  (t.DOMinfo.style.top = t.imageY + "px"));
              }),
              document.body.addEventListener("resize", function () {
                (t.screenW =
                  ...
                  (t.screenH =
                    ...
                    document.documentElement.clientHeight ||
                    document.body.clientHeight),
                  t.imageY + t.imageH > t.screenH &&
                    ((t.imageY = t.screenH - t.imageH),
                    (t.DOMdiv.style.top = t.imageY + "px")),
                  t.imageX + t.imageW > t.screenW &&
                    ((t.imageX = t.screenW - t.imageW),
                    (t.DOMdiv.style.left = t.imageX + "px"));
              }),
              ...
              this.DOMdiv.addEventListener("mouseup", function (e) {
                t.dragging
                  ...
                  : "yes" === t.userOptions.allowPopup &&
                    ((t.DOMinfo.style.left =
                      Math.min(
                        t.screenW - t.imageW,
                        Math.max(t.imageW, parseInt(t.imageX + t.imageW / 2))
                      ) + "px"),
                    (t.DOMinfo.style.top = parseInt(t.imageY) + "px"),
                    t.DOMinfo.Show(),
                    (t.infobox = !0));
              }),
              ...
              a = document
                ...
                .appendChild(
                  document.createTextNode(
                    n.getElementsByTagName("title")[0].textContent
                  )
                ),
              s = document.createElement("sup"),
              o = document.createElement("a"),
              r = document.createElement("p");
            s.appendChild(document.createTextNode("App v." + VERSION)),
              s.appendChild(document.createElement("br")),
              s.appendChild(
                document.createTextNode(
                  "Pet v." + n.getElementsByTagName("version")[0].textContent
                )
              ),
              s.setAttribute("style", "float:right;text-align:right;"),
              ...
              r.appendChild(
                document.createTextNode(
                  n.getElementsByTagName("info")[0].textContent
                )
              ),
              r.setAttribute(
                "style",
                "font-size:" +
                  (100 -
                    parseInt(
                      n.getElementsByTagName("info")[0].textContent.length / 10
                    )) +
                  "%;"
              ),
              this.DOMinfo.appendChild(s),
              this.DOMinfo.appendChild(o),
              "none" !== this.userOptions.allowPets &&
                ((o = document.createElement("a")).appendChild(
                  document.createTextNode("⚙")
                ),
        ...
        },
        {
          ...
          value: function (e, t, i) {
            this.DOMdiv &&
              (i
                ? ((this.imageX = parseInt(e)), (this.imageY = parseInt(t)))
                : ((this.imageX = parseInt(this.imageX) + parseInt(e)),
                  (this.imageY = parseInt(this.imageY) + parseInt(t))),
        ...
        },
        {
          ...
          value: function () {
            for (
              ...
              t += parseInt(e[0].getAttribute("probability"));
            var n = Math.random() * t;
            for (t = 0, i = 0; i < e.length; i++)
              if (
                (t += parseInt(e[i].getAttribute("probability"))) >= n ||
                i == e.length - 1
              ) {
                this._setPosition(
                  this._parseKeyWords(
                    e[i].getElementsByTagName("x")[0].textContent
                  ),
                  this._parseKeyWords(
                    e[i].getElementsByTagName("y")[0].textContent
                  ),
                  !0
                ),
                  ACTIVATE_DEBUG &&
                  ...
                  (this.animationId =
                    e[i].getElementsByTagName("next")[0].textContent),
                  (this.animationStep = 0);
                for (
                  var a = this.xmlDoc
                      .getElementsByTagName("animations")[0]
                  ...
                  if (a[s].getAttribute("id") == this.animationId) {
                    ...
                    a = this.xmlDoc
                      .getElementsByTagName("childs")[0]
                      .getElementsByTagName("child");
                    for (var o = 0; o < a.length; o++)
                      if (
                        a[o].getAttribute("animationid") == this.animationId
                      ) {
                        ACTIVATE_DEBUG && console.log("Child from Spawn");
                        var r = new eSheep(null, !0);
                        r.animationId =
                          a[o].getElementsByTagName("next")[0].textContent;
                        var m = a[o].getElementsByTagName("x")[0].textContent,
                          l = a[o].getElementsByTagName("y")[0].textContent;
                        r._setPosition(
                          this._parseKeyWords(m),
                          this._parseKeyWords(l),
                          !0
                        ),
                          r.Start(this.animationFile);
                        break;
                      }
                    break;
                  }
        ...
        },
        {
          ...
          value: function _parseKeyWords(value) {
            (value = value.replace(/screenW/g, this.screenW)),
              ...
              (value = value.replace(/random/g, 100 * Math.random())),
        ...
        },
        {
          ...
          value: function (e) {
            ...
            for (var s = 0; s < t.length; s++)
              n += parseInt(t[s].getAttribute("probability"));
            var o = Math.random() * n,
              r = 0;
            ...
            for (s = 0; s < i.length; s++)
              if (i[s].getAttribute("id") == t[r].textContent) {
                (this.animationId = i[s].getAttribute("id")),
                  (this.animationStep = 0),
                  (this.animationNode = i[s]),
                  (a = !0);
                break;
              }
            if (a) {
              ...
              for (s = 0; s < i.length; s++)
                if (i[s].getAttribute("animationid") == this.animationId) {
                  ...
                  m.animationId =
                    i[s].getElementsByTagName("next")[0].textContent;
                  var l = i[s].getElementsByTagName("x")[0].textContent,
                    h = i[s].getElementsByTagName("y")[0].textContent;
                  m._setPosition(
                    this._parseKeyWords(l),
                    this._parseKeyWords(h),
                    !0
                  ),
                    m.Start(this.animationFile);
                  break;
                }
            }
            return a;
        ...
        },
        {
          ...
          value: function () {
            ...
            for (var a in (this.HTMLelement && (n = 5), COLLISION_WITH))
              for (
                var s = document.body.getElementsByTagName(COLLISION_WITH[a]),
                  o = 0;
                o < s.length;
                o++
              )
                if (
                  i > (e = s[o].getBoundingClientRect()).top - 2 &&
                  i < e.top + n &&
                  t > e.left &&
                  t < e.right - this.imageW
                ) {
                  var r = window.getComputedStyle(s[o]);
                  if (
                    "" != r.borderTopStyle &&
                    "none" != r.borderTopStyle &&
                    "none" != r.display
                  )
                    return s[o];
                }
        ...
        },
        {
          ...
          value: function (e, t, i) {
            if (
              this.animationNode &&
              this.animationNode.getElementsByTagName(e)
            ) {
              if (
                this.animationNode
                ...
                var n = this.animationNode
                  .getElementsByTagName(e)[0]
                  .getElementsByTagName(t)[0].textContent;
        ...
        },
        {
          ...
          value: function () {
            if (!this.prepareToDie) {
              var e,
                t = this._getNodeValue("start", "x", 0),
                i = this._getNodeValue("start", "y", 0),
                n =
                  (this._getNodeValue("start", "offsety", 0),
                  this._getNodeValue("start", "opacity", 1),
                  this._getNodeValue("start", "interval", 1e3)),
                a = this._getNodeValue("end", "x", 0),
                s = this._getNodeValue("end", "y", 0),
                o =
                  (this._getNodeValue("end", "offsety", 0),
                  this._getNodeValue("end", "interval", 1),
                  this._getNodeValue("end", "interval", 1e3)),
                r = this._parseKeyWords(
                  this.animationNode
                    .getElementsByTagName("sequence")[0]
                    .getAttribute("repeat")
                ),
                m = this.animationNode
                  .getElementsByTagName("sequence")[0]
                ...
                ((e =
                  ...
                  this.animationNode.getElementsByTagName("frame").length
                    ...
                    : this.animationNode.getElementsByTagName("frame")[
                        parseInt(m) +
                          parseInt(
                            (this.animationStep - m) %
                              (this.animationNode.getElementsByTagName("frame")
                                .length -
                                m)
                          )
                      ].textContent),
                (this.DOMimg.style.left =
                  -this.imageW * (e % this.tilesX) + "px"),
                (this.DOMimg.style.top =
                  -this.imageH * parseInt(e / this.tilesX) + "px"),
                this.dragging || this.infobox)
              )
                return (
                  this.animationStep++,
                  void setTimeout(this._nextESheepStep.bind(this), 50)
                );
              if (
                (this.flipped && ((t = -t), (a = -a)),
                0 == this.animationStep
                  ? this._setPosition(t, i, !1)
                  : this._setPosition(
                      parseInt(t) +
                        parseInt(((a - t) * this.animationStep) / g),
                      parseInt(i) +
                        parseInt(((s - i) * this.animationStep) / g),
                      !1
                    ),
                this.animationStep++,
                this.animationStep >= g)
              ) {
                if (this.animationNode.getElementsByTagName("action")[0])
                  switch (
                    this.animationNode.getElementsByTagName("action")[0]
                      .textContent
                  ) {
                    case "flip":
                      "rotateY(0deg)" == this.DOMdiv.style.transform
              ...
              if (
                !(
                  (h &&
                    h[0] &&
                    h[0].getElementsByTagName("next") &&
                    (a < 0 && this.imageX < 0
                      ? ((this.imageX = 0), (d = !0))
                      : a > 0 && this.imageX > this.screenW - this.imageW
                      ? ((this.imageX = this.screenW - this.imageW),
                        (this.DOMdiv.style.left = parseInt(this.imageX) + "px"),
                        (d = !0))
                      : s < 0 && this.imageY < 0
                      ? ((this.imageY = 0), (d = !0))
                      : s > 0 && this.imageY > this.screenH - this.imageH
                      ? ((this.imageY = this.screenH - this.imageH), (d = !0))
                      : s > 0
                      ? this._checkOverlapping() &&
                      ...
                      : this.HTMLelement &&
                        (this._checkOverlapping() ||
                          ...
                          this.imageY + this.imageH <
                            ...
                            : ((this.imageX = parseInt(this.imageX - 3)),
                              (d = !0)),
                          (this.DOMdiv.style.left =
                            parseInt(this.imageX) + "px"))),
                    d && !this._getNextRandomNode(h[0]))) ||
                  (!d &&
                    l &&
                    l[0] &&
                    l[0].getElementsByTagName("next") &&
                    this.imageY < this.screenH - this.imageH - 2 &&
                    (null == this.HTMLelement
                      ? (d = !0)
                      : this._checkOverlapping() ||
                        ((d = !0), (this.HTMLelement = null)),
                    d && !this._getNextRandomNode(l[0])))
                )
              )
                return !d &&
                  ((this.imageX < -this.imageW && a < 0) ||
                    (this.imageX > this.screenW && a > 0) ||
                    (this.imageY < -this.imageH && i < 0) ||
                    (this.imageY > this.screenH && s > 0))
                  ? ((d = !0), void (this.isChild || this._spawnESheep()))
                  : void setTimeout(
                      this._nextESheepStep.bind(this),
                      parseInt(n) + parseInt(((o - n) * this.animationStep) / g)
                    );
            }
          },
        },
                ...
                console.log(i),
                  i.pets &&
                    e.addEventListener("mouseup", function (n) {
                      ...
                      a.setAttribute(
                        "style",
                        "position:absolute;left:0px;top:20px;width:183px;min-height:100px;background:linear-gradient(to bottom, #8080ff, #3030a1);color:yellow;"
                      ),
                        e.parentNode.appendChild(a);
                      var s = function (e) {
                        (r = document.createElement("b")).setAttribute(
                          "style",
                          "cursor:pointer;display:block;"
                        ),
                          r.appendChild(
                            document.createTextNode(i.pets[e].folder)
                          ),
                          r.addEventListener("click", function () {
                            new eSheep(t.userOptions).Start(
                              "https://adrianotiger.github.io/desktopPet/Pets/" +
                                i.pets[e].folder +
                                "/animations.xml"
                            ),
                              t.remove();
